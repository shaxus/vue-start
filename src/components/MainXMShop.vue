	...
	<div class="container">
		...
		<div class="header_bar">
          ...
          <!--<span style="display: inline-block">-->
           <!--<i class="el-icon-shopping-cart-2">购物车<span>({{shopValue}})</span></i>-->
        <!--</span>-->
								...
								<ul>
									<li style="border: 1px solid red">
										...
										<a href="#" class="nav_item_con_img">
											<img src="../../static/images/xiaomixilie/f515ab05232ed14ccd78ec67e024495a.png" />
										</a>
			...
			<div class="flashover con_width clearfix">
				...
				<div class="goods_item_right">
					<div class="goods_item_list">
						<div class="goodlist_content">
							<a href="#"><img src="../../static/images/pms_1527684990.93616987-220220.jpg" alt=""></a>
				...
				<div class="wiring_right" id="houseElectricalDiv">
					...
					<div class="wiring_right_con">
						<div class="goods_item_list">
							<div class="goodlist_content">
								<label>享8折</label>
								<a href="#"><img src="../../static/images/pms_1490077569.08131612-220220.png" alt=""></a>
						...
						<div class="goods_item_list_last">
							<div class="goods_item_last_list clearfix">
								...
								<div class="goods_item_last_list_right">
									<img src="../../static/images/pms_1479190789.95594557-220220.jpg" />
								</div>
							</div>
							<div class="goods_item_last_list clearfix">
								<div class="goods_item_last_list_left">
				...
				<div class="wiring_right">
					...
					<div class="goods_item_list_last">
						<div class="goods_item_last_list clearfix">
							...
							<div class="goods_item_last_list_right">
								<img src="../../static/images/pms_1477985364.89714934-220220.jpg" />
							</div>
						</div>
						<div class="goods_item_last_list clearfix">
							<div class="goods_item_last_list_left">
		...
		<!-- 底部 end -->
		<!-- 侧边栏 -->
		<!--<div style="position:fixed;top: 50px;width:50px;height:100px;z-index: 99;right: 0px;left: auto;margin-left: 0;">111</div>-->
	</div>
</template>
